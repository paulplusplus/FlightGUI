...
var creates = [ // UNIQUE , CONSTRAINT email_unique UNIQUE(email)
    'CREATE TABLE Customers(CustID INTEGER PRIMARY KEY AUTOINCREMENT, UserName TEXT, Email TEXT, Password TEXT);',
    ...
    'CREATE TABLE Cust_Flight(CustID INT, FlightID INT, GuiSearch NUMERIC, FOREIGN KEY (CustID) REFERENCES Customer(CustID) ON DELETE CASCADE, FOREIGN KEY (FlightID) REFERENCES Flights(FlightID) ON DELETE CASCADE);'
]
